/**
 * Support Login Page
 * Authentication page for EzyFix Support Portal
 */
...
export default function SupportLoginPage() {
  ...
  const permissionError = urlError === 'insufficient_permissions'
    ? 'You do not have permission to access Support Portal. Admin or Support role required.'
    : null;
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="support@ezyfix.com"
                required
              />
            </div>
          </div>
